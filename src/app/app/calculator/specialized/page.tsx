          ...
          <Grid.Col span={6}>
            <CustomSelectInput
              ...
              onChange={(data => {
                ...
                form.setFieldValue(
                  'result',
                  calculate(form.getValues().num360, CONFIG_DATA_CALCULATOR[PRODUCT_ID_360].libData) +
                  calculate(form.getValues().mount, CONFIG_DATA_CALCULATOR[Number(data)].libData)
                )
              })}
