...
const validateDelete = (ids: number[]): adapterResponseI<Array<projectDescriptionModel>> => {
...
const validateGet = (ids?: number[]): adapterResponseI<Array<projectDescriptionModel>> => {
